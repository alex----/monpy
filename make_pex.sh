...
python -mplatform | grep Ubuntu && sudo apt-get update && sudo apt-get install python-dev libpng-dev libfreetype6-dev g++ || echo "Not Ubuntu skipping matplotlib deps"
